...
# covering fonksiyonunu çağırarak değerlendirmeyi yap
...
result = covering(annotations, predictions, n_obs)
print("Average Segmentation Covering:", result)
f_measure_result, precision, recall = f_measure(annotations, predictions, return_PR=True)
...
# covering fonksiyonunu çağırarak değerlendirmeyi yap
covering_result = covering(annotations, predictions, n_obs)

# Sonucu yazdır
print("Average Segmentation Covering:", covering_result)