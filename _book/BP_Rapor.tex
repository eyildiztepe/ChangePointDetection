...
\title{PROJE BAŞLIĞI}
%\author{Yazar1 Adı SoyadıYazar2 Adı SoyadıYazar3 Adı Soyadı} %Tek yazar için
\author{Yazar1 Adı Soyadı \\ Yazar2 Adı Soyadı \\ Yazar3 Adı Soyadı} %Çok yazar için
...
\Acknowledgements{
Tüm çalışma süresince yönlendiriciliği, katkıları ve yardımları ile yanımızda olan danışmanımız Dr.~Ad Soyad 'ye ve böyle bir çalışmayı yapmamız için bize fırsat tanıyan Dokuz Eylül Üniversitesi Fen Fakültesi İstatistik Bölümüne teşekkür ederiz.\\
~\\
~\\
Yazar1 Adı Soyadı\\
Yazar2 Adı Soyadı\\
...
\begin{figure}
\centering
\includegraphics{figure/ist.png}
\caption{\label{fig:istlogo}IST logo}
\end{figure}
...
\leavevmode\hypertarget{ref-deussen2000}{}%
...
\leavevmode\hypertarget{ref-hipr1997}{}%
...
\leavevmode\hypertarget{ref-jain1989}{}%
