...
\begin{itemize}
\item \textbf{C}: Bir parça için maliyet fonksiyonu
...
Eğer bu koşul sağlanmıyorsa, o zaman herhangi bir değişim noktası tespit edilememiştir ve algoritma durur. Aksi takdirde veri, belirlenen değişim noktasından önce ve sonra olmak üzere iki parçaya bölünür. Tek değişim noktası tespit yöntemi, değişiklikten önce ve sonra iki yeni parçaya da tekrarlanır. Her iki parçada da değişim noktaları belirlenirse, bunları yeni belirlenen değişim noktasında daha fazla parçalara böler ve her yeni parçaya değişim noktası tespit yöntemini uygular. Bu süreç, verinin herhangi bir bölümünde değişim noktası bulunamayana kadar devam eder(Killick, Fearnhead ve Eckley (2012)).
...
Burada, \(C\) bir parça için bir maliyet fonksiyonu ve \(\beta f(m)\) aşırı uyum karşısında koruma sağlayan bir ceza terimidir.
...
\[ F1\text{-}Puanı = \frac{2 * Kesinlik * Duyarlılık}{(Kesinlik + Duyarlılık)} \]
